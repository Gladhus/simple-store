	 ...
	 addToCart(product,productQuantity) {
		 if(productQuantity != 0 )
		 {
			if ( this.shoppingCart[product.id] == null ){
				...
				this.shoppingCart[product.id].quantity = this.shoppingCart[product.id].quantity + productQuantity;
				this.shoppingCart[product.id].totalPrice = this.shoppingCart[product.id].totalPrice + product.price*productQuantity;
			}
